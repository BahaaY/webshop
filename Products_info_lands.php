<html>
    ...
    <?php
        ...
        include("php/products_info_lands.php");
    ...
    <body class="body_main">
        ...
        <section class="header">
            ...
            <div class="col">
                <span class="product_title_info_large">Lands</span>
            </div>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="col_div">
                    <div class="col">
                        ...
                        <input type="text" name="input_price_lb" id="input_price_lb" value="<?php if(isset($_POST['input_price_lb'])) echo $input_price_lb ?>" required >
                        <label id="label_price_lb">Price in LB</label>
                    </div>
                    <div class="col">
                        <i class="fa fa-dollar" ></i>
                        <input type="text" name="input_price_usd" id="input_price_usd" value="<?php if(isset($_POST['input_price_usd'])) echo $input_price_usd ?>" required >
                ...
                <div class="col_div">
                    <div class="col">
                        ...
                        <input type="text" name="input_title" id="input_title" value="<?php if(isset($_POST['input_title'])) echo $input_title ?>" required >
                        <label id="label_title">Title</label>
                    </div>
                    <div class="col">
                        <i class="fa fa-comment" ></i>
                        <input type="text" name="input_description" id="input_description" value="<?php if(isset($_POST['input_description'])) echo $input_description ?>" required >
                ...
                <div class="col_div">
                    ...
                    <div class="col">
                        ...
                        <input type="text" name="input_size" id="input_size" value="<?php if(isset($_POST['input_size'])) echo $input_size ?>" required >
                ...
                <div class="col_div">
                    <div class="col">
                        ...
                        <input type="text" name="input_location" id="input_location" value="<?php if(isset($_POST['input_location'])) echo $input_location ?>" required >
