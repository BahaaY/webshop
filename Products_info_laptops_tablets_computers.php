<html>
    ...
    <?php
        ...
        include("php/products_info_laptops_tablets_computers.php");
    ...
    <body class="body_main">
        ...
        <section class="header">
            ...
            <div class="col">
                <span class="product_title_info_xsmall">Laptops, Tablets & Computers</span>
            </div>
                ...
                <div class="col_div">
                    ...
                    <div class="col">
                        <select name="condition">
                            ...
                            <?php
                                $s="";
                                foreach($array_condition_laptop_tablet_computer as $val){
